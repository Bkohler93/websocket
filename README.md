...
[![Go Reference](https://pkg.go.dev/badge/github.com/Bkohler93/websocket.svg)](https://pkg.go.dev/github.com/Bkohler93/websocket)
...
```sh
go get github.com/Bkohler93/websocket
```
...
- [Zero dependencies](https://pkg.go.dev/github.com/Bkohler93/websocket?tab=imports)
- JSON helpers in the [wsjson](https://pkg.go.dev/github.com/Bkohler93/websocket/wsjson) subpackage
- Zero alloc reads and writes
- Concurrent writes
- [Close handshake](https://pkg.go.dev/github.com/Bkohler93/websocket#Conn.Close)
- [net.Conn](https://pkg.go.dev/github.com/Bkohler93/websocket#NetConn) wrapper
- [Ping pong](https://pkg.go.dev/github.com/Bkohler93/websocket#Conn.Ping) API
- [RFC 7692](https://tools.ietf.org/html/rfc7692) permessage-deflate compression
- [CloseRead](https://pkg.go.dev/github.com/Bkohler93/websocket#Conn.CloseRead) helper for write only connections
- Compile to [Wasm](https://pkg.go.dev/github.com/Bkohler93/websocket#hdr-Wasm)
...
- No extra goroutine per connection to support cancellation with context.Context. This costs github.com/Bkohler93/websocket 2 KB of memory per connection.
...
Advantages of github.com/Bkohler93/websocket:

- Minimal and idiomatic API
  - Compare godoc of [github.com/Bkohler93/websocket](https://pkg.go.dev/github.com/Bkohler93/websocket) with [gorilla/websocket](https://pkg.go.dev/github.com/gorilla/websocket) side by side.
- [net.Conn](https://pkg.go.dev/github.com/Bkohler93/websocket#NetConn) wrapper
...
- Idiomatic [ping pong](https://pkg.go.dev/github.com/Bkohler93/websocket#Conn.Ping) API
  - Gorilla requires registering a pong callback before sending a Ping
- Can target Wasm ([gorilla/websocket#432](https://github.com/gorilla/websocket/issues/432))
- Transparent message buffer reuse with [wsjson](https://pkg.go.dev/github.com/Bkohler93/websocket/wsjson) subpackage
...
- [CloseRead](https://pkg.go.dev/github.com/Bkohler93/websocket#Conn.CloseRead) helper for write only connections ([gorilla/websocket#492](https://github.com/gorilla/websocket/issues/492))
...
The [net.Conn](https://pkg.go.dev/github.com/Bkohler93/websocket#NetConn) can help in transitioning
to github.com/Bkohler93/websocket.
...
When writing idiomatic Go, github.com/Bkohler93/websocket will be faster and easier to use.
